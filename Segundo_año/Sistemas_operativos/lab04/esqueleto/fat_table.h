...
/* Si es el ultimo cluster y esta lleno reserva un nuevo cluster, sino 
 * es igual fat_table_get_next_cluster. 
*/
u32 fat_table_next_cluster_or_new_cluster(fat_table table, u32 cluster);
