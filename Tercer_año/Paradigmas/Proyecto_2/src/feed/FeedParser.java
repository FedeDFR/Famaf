...
public class FeedParser {
    ...
    public static List<Article> parseXML(String xmlData) {
        ...
        try {
            ...
            // Parsea el InputSource, que es el xmlData transformado en un flujo de lectura de caracteres y crea un arbol de nodos Document. 
    ...
    // Este metodo se encarga de guardar todos los datos de un tipo de etiqueta (Ej: guarda todos los title)
    ...
    public static String fetchFeed(String feedURL) throws MalformedURLException, IOException, Exception {
        ...
        // No cambiamos User-agent para no romper la funcionalidad, ya que los links de pagina 12 no funcionan si realizamos el cambio.
