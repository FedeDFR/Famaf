...
public class App {
    ...
    private static void run(Config config, List<FeedsData> feedsDataArray, List<DictionaryData> dictionaryDataArray ) throws MalformedURLException, IOException, Exception {
        ...
        if (config.getComputeNamedEntities()) {
            ...
            if (config.getHeuristicKey().equals("1")) {
                ...
                // Revisamos como funciona la extraccion de candidatos
                for (Article art : allArticles) {
                    
                    candidatos.addAll(namedEntities.heuristics.CapitalizedWordHeuristic.extractCandidates(art.getDescription()));
                    
                }

                // Imprimimos los candidatos
                ...
                for (Article art : allArticles) {
                    ...
                    candidatos = namedEntities.heuristics.idea1.identifyNamedEntities(art.getDescription());
                }    
                ...
                for (Article art : allArticles) {
                    ...
                    candidatos.addAll(namedEntities.heuristics.idea2.extractCandidates(art.getDescription()));
                }
            ...
            for(String c : candidatos) {
                ...
                // Totamos en diccionario y comparamos con los candidatos
            ...
            // Imprimimos a las entidades
            for (NamedEntity en : entitiesList) {
