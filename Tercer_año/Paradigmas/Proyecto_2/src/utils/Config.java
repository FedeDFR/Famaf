...
public class Config {
    ...
    public Config(boolean printFeed, boolean computeNamedEntities, boolean showHelp, String feedKey, String heuristicKey, String statsFormat, boolean printStats, boolean feedOne) {
    ...
    //Se puede agregar un bool para printear todos (para -pf o cuando -ne no tiene args)
}
