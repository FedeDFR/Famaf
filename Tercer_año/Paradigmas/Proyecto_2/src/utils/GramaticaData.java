...
public class GramaticaData {
    ...
    public GramaticaData(List<String> adjetivos,List<String> verbos,List<String> determinantes, List<String> pronombres, List<String> conjunciones, List<String> preposiciones, List<String> adverbios, List<String> sustantivos) {
