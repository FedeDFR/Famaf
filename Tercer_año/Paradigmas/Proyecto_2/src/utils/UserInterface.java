...
public class UserInterface {
    ...
    public Config handleInput(String[] args) {
        ...
        return new Config(printFeed, computeNamedEntities, showHelp, feedKey, heuristicKey, statsFormat, printStats, feedOne);
    }
    ...
    public static void printHelp(List<FeedsData> feedsDataArray) {
        ...
        System.out.println("                                       Heuristic 1: <description>");
        System.out.println("                                       Heuristic 2: <description>");
        System.out.println("                                       Heuristic 3: <description>");
